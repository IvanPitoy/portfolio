...
const CATEGORIES: { eyebrow: string; title: string; description: string; projects: Project[] }[] = [
  { eyebrow:"Category 01", title:"Talking Heads + Motion", description:"Interview and talking-head edits with dynamic captions.",
    projects:[
      { id:"th-1", videoUrl:"https://res.cloudinary.com/djx1orgmd/video/upload/v1782943092/Real_State_sgln7s.mp4", description:"Talking-head edit with Motion Graphics." },
      { id:"th-2", videoUrl:"https://res.cloudinary.com/djx1orgmd/video/upload/v1782943094/Talking_Head_W_Mg_ikqgf9.mp4", description:"Talking-head edit with Motion Graphics." },
      { id:"th-3", videoUrl:"https://res.cloudinary.com/djx1orgmd/video/upload/v1782943091/Talking_Heads_ebktso.mp4", description:"Talking-head edit with B-rolls." },
    ]},
  { eyebrow:"Category 02", title:"Motion Graphics", description:"Kinetic type, animated overlays, and brand motion packages.",
    projects:[
      { id:"mg-1", videoUrl:"https://res.cloudinary.com/djx1orgmd/video/upload/v1782943095/Motion_Graphics_5_kjgkke.mp4", description:"Kinetic typography and Motion Graphics." },
      { id:"mg-2", videoUrl:"https://res.cloudinary.com/djx1orgmd/video/upload/v1782943096/Motion_Graphics_4_uzwie7.mp4", description:"Kinetic typography and Motion Graphics." },
      { id:"mg-3", videoUrl:"https://res.cloudinary.com/djx1orgmd/video/upload/v1782943096/Motion_Graphics_6_vujlpt.mp4", description:"Kinetic typography and Motion Graphics." },
    ]},
  { eyebrow:"Category 03", title:"Brand Ads", description:"Commercial and brand content crafted to convert viewers into customers.",
    projects:[
      { id:"ba-1", videoUrl:"https://res.cloudinary.com/djx1orgmd/video/upload/v1782943094/Promo_Ad_2_brcjwv.mp4", description:"Product Advertisement." },
      { id:"ba-2", videoUrl:"https://res.cloudinary.com/djx1orgmd/video/upload/v1782943091/Campaign_Ad_Day_1_r40npi.mp4", description:"Product Advertisement." },
  ...
  { eyebrow:"Category 05", title:"Gaming Edits", description:"High-energy gaming content built for YouTube and short-form platforms.",
    projects:[
      { id:"ge-1", videoUrl:"https://res.cloudinary.com/djx1orgmd/video/upload/v1782943096/Content_7_qguxl3.mp4", description:"Roblox highlight montage edit." },
      { id:"ge-2", videoUrl:"https://res.cloudinary.com/djx1orgmd/video/upload/v1782943097/First_Valo_Edit_abyj6v.mp4", description:"Valorant highlight edit with lyric-synced cuts." },
      { id:"ge-3", videoUrl:"https://res.cloudinary.com/djx1orgmd/video/upload/v1782943095/0515_1_q4ndma.mp4", description:"Roblox comedy & meme content edit for YouTube." },
    ]},
];
